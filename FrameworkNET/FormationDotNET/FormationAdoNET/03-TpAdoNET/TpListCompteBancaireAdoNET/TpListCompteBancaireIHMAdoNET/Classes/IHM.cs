...
namespace TpListCompteBancaireIHMAdoNET.Classes
{
    internal class IHM
    {        
        public IHM()
        ...
        private void ActionDepot()
        {
            ...
            if (compte != null)
            {
                ...
                Operation o = new(compte.Id, montant);
                if (compte.Depot(o))
        ...
        private void ActionRetrait()
        {
            ...
            if (compte != null)
            {
                ...
                Operation o = new(compte.Id, montant * -1);
                if (compte.Retrait(o))
        ...
        private void ActionAfficherCompte()
        {
            ...
            if (compte != null)
            {
                //Console.WriteLine(compte.GetType().ToString());
                OnDarkCyanInput("\n---------------------- Compte N° ");
        ...
        private Compte ActionRechercheCompte()
        {
            ...
            compte = compte.RechercherCompte(index);
            if (compte == null)
